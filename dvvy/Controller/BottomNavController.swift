...
//        navigationBar.barTintColor = UIColor(red:0.95, green:0.45, blue:0.38, alpha:1.0)
        ...
        self.toolbar.frame = CGRect(x: 0, y: view.frame.height-height, width: view.frame.width, height: height)
        self.toolbar.tintColor = UIColor.white
        self.toolbar.barTintColor = UIColor(red:0.95, green:0.45, blue:0.38, alpha:1.0)
